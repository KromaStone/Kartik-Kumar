            ...
            <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-10">
                ...
                <div className="flex flex-row items-center justify-between">
                    ...
                    <Circle ref={div4Ref} className="size-16 ">
                        <a target="_blank" href="https://kartik-kumar.vercel.app" className="flex items-center justify-center w-auto size-16 text-xl font-bold px-3 text-[#121212] bg-[linear-gradient(#fff_50%,_#121212_50%)] bg-[length:100%_200%] bg-[position:0%_0%] rounded-lg shadow-md transition-[background-position,color] duration-500 hover:bg-[position:0%_100%] hover:text-white z-40">
